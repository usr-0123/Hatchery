...
hatchRecordRoutes.patch('/hatcheRecord/update/:hatchRecordId', verifyTokenMiddleware, updateHatchController)
hatchRecordRoutes.delete('/hatchRecord/delete/:hatchRecordId', verifyTokenMiddleware, deleteHatchRecordController)
